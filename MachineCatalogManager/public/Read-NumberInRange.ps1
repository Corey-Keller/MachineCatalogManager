function Read-NumberInRange
{
  ...
  #$PSBoundParameters.Keys.foreach{Write-Host "$_ = $($PSBoundParameters[$_])"}
  ...
  Write-Host "[NOTE]: Negative numbers will leave that many servers out of Maintenance Mode, and put the rest in Maintenance Mode"
  try {
